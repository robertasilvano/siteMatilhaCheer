                ...
                <div class="container-cadastro">
                    <form method="post" action="">
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="diretoria" class="visually-hidden">Membro da diretoria</label>
                            <select id="diretoria" name="diretoria" class="form-control" require>
                                <option value="sim">É membro da diretoria</option>
                                <option value="nao" selected>Não é membro da diretoria</option>
                            </select>
                        </div>
                        <br>
